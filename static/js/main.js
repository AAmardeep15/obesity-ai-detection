...
(function () {
  ...
  else if (path.startsWith("/predict") && navPredict)
    navPredict.classList.add("active");
  else if (path.startsWith("/advance") && navAdvance)
    navAdvance.classList.add("active");
  else if (path.startsWith("/learn") && navLearn)
    navLearn.classList.add("active");
  else if (path.startsWith("/statistics") && navStats)
    navStats.classList.add("active");
  else if (path.startsWith("/educate") && navEducate)
    navEducate.classList.add("active");
})();
